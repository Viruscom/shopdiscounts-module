...
class Discount extends Model
{
    ...
    public function getHumanReadableType()
    {
        $types = [
            ...
            self::$FIXED_PERCENT_TYPE_ID       => trans('shop::admin.discounts.type_fixed_amount'),
            self::$FIXED_FREE_DELIVERY_TYPE_ID => trans('shop::admin.discounts.type_fixed_amount'),
            self::$QUANTITY_TYPE_ID            => trans('shop::admin.discounts.type_fixed_amount'),
            self::$BONUS_ON_ITEM_TYPE_ID       => trans('shop::admin.discounts.type_fixed_amount'),
        ];
