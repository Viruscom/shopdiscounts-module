<?php
    ...
    class FixedPercentDiscountRequest extends FormRequest
    {
        /**
        ...
        public function validateSupplierPriceLimit()
        {
            ...
            if (Discount::hasSupplierPriceLimitError(Discount::$FIXED_PERCENT_TYPE_ID, $this->aplies_to, ['product_id' => $this->product_id, 'brand_id' => $this->brand_id, 'categories_ids' => $this->categories_ids], $this->value)) {
